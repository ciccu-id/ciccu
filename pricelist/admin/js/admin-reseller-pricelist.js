...
var kiPkg=ce('button','kebab-item','＋ Tambah Paket');
kiPkg.setAttribute('type','button');
kiPkg.addEventListener('click',function(e){e.stopPropagation();kebab.classList.remove('open');openRvarEdit(null,app)});
