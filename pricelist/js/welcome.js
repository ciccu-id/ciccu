...
card.appendChild(ce('p',null,'𓏭 🌷⭐️ 𝗪𝗼𝗿𝗸𝗶ie land . . . 🪽 ♡ !? open 🥣🌱 ꕤ⁺◦ ⌒ 𓈒♡ ぬいぐるみ . . あまぬい 👛 ‧ . ⊹ 𓏭ᱸ♡ ⌗ 🧁 ？あまい 🎀☘️ ⊹ ふわあま 🥛 ♡ !? softie doll 🐰🍭 𓂃 ˚ 𖠗'));
...
pricelistBtn.style.padding='1rem 2rem';
pricelistBtn.style.fontSize='1rem';
pricelistBtn.style.borderRadius='var(--r-xl)';
pricelistBtn.style.boxShadow='var(--sh-lg)';
pricelistBtn.appendChild(svgI('M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z','1.25rem','1.25rem'));
pricelistBtn.appendChild(ce('span',null,'Lihat Pricelist'));
pricelistBtn.appendChild(svgI('M14 5l7 7m0 0l-7 7m7-7H3','1rem','1rem'));
...
h4.style.fontWeight='700';h4.style.color='var(--pk500)';h4.style.fontSize='.875rem';h4.style.marginBottom='.375rem';
div.appendChild(h4);
var p=ce('p',null,s.text);
p.style.fontSize='.75rem';p.style.color='var(--g600)';p.style.fontWeight='500';p.style.lineHeight='1.625';p.style.paddingLeft='1.25rem';p.style.textAlign='justify';
div.appendChild(p);
...
netflixBtn.style.marginTop='.5rem';
netflixBtn.appendChild(svgI('M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z','1rem','1rem'));
