...
const ro=await env.DB.prepare("SELECT o.id,o.order_code,o.total_amount,o.status,o.created_at,COALESCE(r.username,'') AS username FROM rsl_orders o LEFT JOIN rsl_resellers r ON r.id=o.reseller_id ORDER BY o.id DESC LIMIT 5").all();
