...
var addBtn=ModalKit.btn('＋ Tambah Stok','submit-btn',function(){openAdd()});
s.foot.appendChild(ModalKit.btn('Tutup','cancel-btn',s.close));
...
s.body.appendChild(noteTa.parentNode===s.body?noteWrap:noteWrap);
ctx.noteTa=noteTa;
